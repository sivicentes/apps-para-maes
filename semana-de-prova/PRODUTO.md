...
4e. A tela de fotos abre com **o plano daquela prova**: o que o comunicado pede, o que já foi lido e, em destaque, **quais páginas ainda faltam**. A lista se atualiza sozinha conforme as fotos são lidas, então não é preciso voltar à prova nem processar de pouco em pouco só para saber onde parou. A fila de fotos sobrevive a sair e voltar da tela (mas não a fechar o app), o que permite fotografar em rodadas e processar tudo de uma vez. **[hoje]**
4h. Enviar muitas páginas de uma vez é seguro. As fotos vão em levas de três, e **cada leva é salva assim que entra**: se a leitura parar no meio (limite do dia, queda de rede), o que já foi lido fica guardado e só as páginas restantes continuam na fila — a segunda tentativa não repete o que já entrou nem gasta cota à toa. O aviso diz quantas entraram e por que parou. **[hoje]**
4i. Quando a mãe fotografa o módulo inteiro e o conteúdo de uma leva não cabe numa resposta, o app **divide a leva em partes menores e tenta de novo**, em vez de descartar a leitura. Só avisa que veio cortado se nem uma página sozinha couber. **[hoje]**
4f. Nem todo número no campo de páginas é página. Quando o comunicado marca (*“Páginas: 7, 8 e 9”*, *“págs. 40 a 52”*), só vale o que vem **depois do marcador** — em *“Multiplicação 10, 100 e 1000 – Páginas: 14 e 22”* as páginas são 14 e 22. Sem marcador, valem os números do texto, menos as referências de material e exercício: *“caderno 3”*, *“Apostila 2”*, *“Lección 5 e 6”*, *“questão 7”*, *“4º ano”*. Sem isso o app pedia foto de página inexistente e avisava que faltava material. **[hoje]**
4g. Material que a professora cita **sem páginas** — caderno de classe, atividades extras, revisão no caderno — não é material da apostila: a IA é instruída a descrevê-lo no que cai, marcando *“Opcional:”* quando a professora disser que é, e a não transformá-lo em página para fotografar. **[hoje]**
